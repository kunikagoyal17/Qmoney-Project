...
/*public class User {
    ...
    public List<playlist> playlistid()  //getter
    {
        return  new ArrayList<playlist>(playlistid);
    }
    ...
    public void setplaylistid(List<playlist> playlistid)
    {   //  playlistid =new ArrayList<playlist>(playlistid);
